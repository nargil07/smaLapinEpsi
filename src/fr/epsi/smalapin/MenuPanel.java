...
public class MenuPanel extends JPanel {
    ...
    private JTextField jtfTrueNbRenard;
    ...
    public MenuPanel() {
        ...
        jtfTrueNbRenard = new JTextField();
        jtfTrueNbRenard.setPreferredSize(new Dimension(50, 20));
        ...
        this.add(new JLabel("Nombre renard : "));
        jtfTrueNbRenard.setEnabled(false);
        this.add(jtfTrueNbRenard);
    }
    
    public void setNbLapinTextField(int nbLapin){
        jtfTrueNbLapin.setText(String.valueOf(nbLapin));
    }
    public void setNbRenardTextField(int nbRenard){
        jtfTrueNbRenard.setText(String.valueOf(nbRenard));
    }
